                ...
                <div class="space-y-6">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-100"><?php echo e(Auth::user()->name); ?></p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        <svg class="w-5 h-5 text-gray-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <p class="text-gray-100"><?php echo e(Auth::user()->email); ?></p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        <svg class="w-5 h-5 text-gray-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <p class="text-gray-100"><?php echo e(Auth::user()->created_at->format('F d, Y')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LoginAuth\resources\views/user/dashboard.blade.php ENDPATH**/ ?>