...
<head>
    ...
    *,
    ...
    /* underline utility removed to prefer text styles without underlines */
...
<body class="antialiased">
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <a href="<?php echo e(url('/home')); ?>" class="text-sm text-gray-700 dark:text-gray-500">Home</a>
            <?php else: ?>
            <a href="<?php echo e(route('choose.login')); ?>" class="text-sm text-gray-700 dark:text-gray-500">Log in</a>

            <?php if(Route::has('register')): ?>
            <a href="<?php echo e(route('choose.register')); ?>" class="ml-4 text-sm text-gray-700 dark:text-gray-500">Register</a>
            <?php endif; ?>
            <?php endif; ?>
        </div>
        <?php endif; ?>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs"
                                    class="text-gray-900 dark:text-white">Documentation</a></div>
                        </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laracasts.com"
                                    class="text-gray-900 dark:text-white">Laracasts</a></div>
                        </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel-news.com/"
                                    class="text-gray-900 dark:text-white">Laravel News</a></div>
                        </div>
...
</html><?php /**PATH C:\xampp\htdocs\LoginAuth\resources\views/welcome.blade.php ENDPATH**/ ?>