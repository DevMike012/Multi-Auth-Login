...
<body class="antialiased">
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            @else
            <a href="{{ route('choose.login') }}" class="text-sm text-gray-700 dark:text-gray-500">Log in</a>

            @if (Route::has('register'))
            <a href="{{ route('choose.register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500">Register</a>
            @endif
            @endauth
        </div>
        @endif
