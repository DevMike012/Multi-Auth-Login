    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div class="bg-emerald-500 rounded-xl p-6 shadow-lg">
            <div class="flex flex-col">
                ...
                <div class="flex items-end justify-between">
                    <div>
                        <span class="text-4xl font-bold text-white">{{ $activeUsers }}</span>
                        <p class="text-white text-sm opacity-75">Active Users</p>
                    </div>
                    <a href="{{ route('admin.dashboard') }}" class="text-white text-sm">More Info →</a>
                </div>
            </div>
        </div>
        ...
        <div class="bg-blue-600 rounded-xl p-6 shadow-lg">
            <div class="flex flex-col">
                ...
                <div class="flex items-end justify-between">
                    <div>
                        <span class="text-4xl font-bold text-white">{{ $adminCount }}</span>
        ...
        <div class="bg-orange-500 rounded-xl p-6 shadow-lg">
            <div class="flex flex-col">
                ...
                <div class="flex items-end justify-between">
                    <div>
                        <span class="text-4xl font-bold text-white">{{ $regularUsers }}</span>
        ...
        <div class="bg-blue-500 rounded-xl p-6 shadow-lg">
            <div class="flex flex-col">
                ...
                <div class="flex items-end justify-between">
                    <div>
                        <span class="text-4xl font-bold text-white">{{ $deletedUsers }}</span>
