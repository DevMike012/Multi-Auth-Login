...
<div class="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
    <div class="max-w-md w-full bg-white border border-gray-200 rounded-2xl shadow-md p-8">
        ...
        <div class="space-y-4">
            <a href="{{ route('register', ['register_as' => 'user', 'role' => 'user']) }}" class="block w-full text-left px-6 py-4 rounded-xl bg-gradient-to-r from-white to-indigo-50 border border-gray-200 hover:shadow-xl transition flex items-center gap-5">
            ...
            <a href="{{ route('register', ['register_as' => 'admin', 'role' => 'admin']) }}" class="block w-full text-left px-6 py-4 rounded-xl bg-gradient-to-r from-white to-yellow-50 border border-gray-200 hover:shadow-xl transition flex items-center gap-5">
        ...
        <div class="mt-6 text-center text-sm text-gray-500">
            ...
            <a href="{{ route('choose.login') }}" class="text-indigo-600 font-medium">Sign in</a>
        </div>
    </div>
</div>
@endsection
